...
def atualizar_funcionario(id_funcionario, nome, cpf, cargo, salario, data_admissao, id_setor):
    #abrir conexão
    conexao = conectar()
    ...
    valores = (nome, cpf, cargo, salario, data_admissao, id_setor, id_funcionario)
